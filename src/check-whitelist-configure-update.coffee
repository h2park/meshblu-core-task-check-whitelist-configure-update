...
class CheckWhitelistConfigureUpdate
  ...
  do: (job, callback) =>
    ...
    emitter = fromUuid
    subscriber = toUuid
    @whitelistManager.checkConfigureUpdate {emitter, subscriber}, (error, verified) =>
...
module.exports = CheckWhitelistConfigureUpdate
